...
# Test with a small subset by limiting the API calls
echo "Testing data processor with limited records..."

# Create a test version that only fetches 1000 records
cat > src/test-limited.ts << 'EOF'
