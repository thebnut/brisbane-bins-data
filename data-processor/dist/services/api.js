...
export class BrisbaneCityAPI {
    ...
    async fetchAllCollectionDays() {
        ...
        do {
            try {
                ...
                const batch = data.results.map((record) => this.mapToPropertyCollection(record));
                results.push(...batch);
    ...
    mapToPropertyCollection(record) {
        return {
